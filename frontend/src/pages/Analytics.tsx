...
const Analytics: React.FC = () => {
  return (
    <div className="p-6 max-w-7xl mx-auto w-full space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-900 font-sans">
          Analytics & Trends
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card title="Daily Biometric Detections" subtitle="Volume of matched faces in the last 7 days">
          <div className="h-64 flex flex-col items-center justify-center bg-gray-50 dark:bg-white/60 rounded-lg border border-dashed border-gray-200 dark:border-slate-200 p-6">
            <span className="material-symbols-outlined text-4xl text-blue-500 mb-2">bar_chart</span>
            <p className="text-sm font-semibold text-gray-800 dark:text-slate-700">Daily Detection Chart</p>
        ...
        <Card title="Security Incident Trends" subtitle="Critical and high severity alert frequency">
          <div className="h-64 flex flex-col items-center justify-center bg-gray-50 dark:bg-white/60 rounded-lg border border-dashed border-gray-200 dark:border-slate-200 p-6">
            ...
            <p className="text-sm font-semibold text-gray-800 dark:text-slate-700">Alert Trend Chart</p>
        ...
        <Card title="Camera Uptime & Performance" subtitle="System availability across all nodes">
          <div className="h-64 flex flex-col items-center justify-center bg-gray-50 dark:bg-white/60 rounded-lg border border-dashed border-gray-200 dark:border-slate-200 p-6">
            ...
            <p className="text-sm font-semibold text-gray-800 dark:text-slate-700">Camera Performance Matrix</p>
        ...
        <Card title="Frequent Visitors & Access Logs" subtitle="Top matched identity statistics">
          <div className="h-64 flex flex-col items-center justify-center bg-gray-50 dark:bg-white/60 rounded-lg border border-dashed border-gray-200 dark:border-slate-200 p-6">
            ...
            <p className="text-sm font-semibold text-gray-800 dark:text-slate-700">Identity Distribution</p>
