...
const NotFound: React.FC = () => {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 bg-gray-50 dark:bg-slate-50 transition-colors duration-200">
      <div className="text-center max-w-md">
        <h1 className="text-8xl font-black text-blue-600 dark:text-blue-500 mb-4 animate-bounce">
          404
        </h1>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-slate-900 mb-2">
          Page Not Found
        </h2>
        <p className="text-gray-600 dark:text-slate-500 mb-8">
