...
const Branches: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto w-full space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-900">Branch Management</h1>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {branches.map((branch) => (
              <Card 
                key={branch.id} 
                className="p-5 relative group border border-gray-250 dark:border-slate-200/80 hover:border-blue-500/50 dark:hover:border-blue-500/50 transition-all shadow-md bg-white dark:bg-white flex flex-col justify-between"
              >
                <div className="space-y-3">
                  {/* Top Line */}
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-mono font-bold tracking-wider text-blue-600 dark:text-blue-600 bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800/50 px-2 py-0.5 rounded uppercase">
                      {branch.code}
                    </span>
                  ...
                  {/* Body Details */}
                  <div>
                    <h3 className="text-base font-semibold text-gray-900 dark:text-slate-900 group-hover:text-blue-500 dark:group-hover:text-blue-600 transition-colors">
                      {branch.name}
                    </h3>
                ...
                <div className="mt-5 pt-3 border-t border-gray-100 dark:border-slate-200 flex justify-end">
                  <button
