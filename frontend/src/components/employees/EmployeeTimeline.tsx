                ...
                <div key={item.id || index} className="flex gap-6 relative">
                  ...
                  <div className="flex-1 ml-8 pb-4">
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      <div className="flex-1 bg-gray-200 dark:bg-slate-700 rounded-full h-2 max-w-xs">
                        <div
                      ...
                      <span className="text-xs text-gray-600 dark:text-gray-400 font-semibold min-w-12">
